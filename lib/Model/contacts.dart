...
class Contacts{
  ...
  //constructor for add
  Contacts(this._firstName,this._lastName,this._phone,this._email,this._address,this._photoUrl);

  //constructor for edit
  Contacts.withId(this._id,this._firstName,this._lastName,this._phone,this._email,this._address,this._photoUrl);
  ...
  Contacts.fromSnapshot(DataSnapshot snapshot){
